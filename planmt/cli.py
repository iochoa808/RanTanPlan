...
def validate_strategy_combination(parallelism, propagator):
    ...
    if parallelism == "forall" and (propagator not in ["forall", "lazy_forall", "null"]):
        return f"Invalid combination: 'forall' parallelism requires 'forall', 'lazy_forall', or 'null' propagator, got '{propagator}'"
