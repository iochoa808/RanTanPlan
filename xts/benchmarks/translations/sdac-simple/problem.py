"""
sdac-simple: counter c0 starts at 1; increment until >= 3, then finish.
Plan: increment(c0) x2, finish(c0) = 3 steps.
PDDL-XTS: sdac-simple
"""
import sys, os
...
def get_problem():
    ...
    p.set_initial_value(value(c0),     Int(1))
