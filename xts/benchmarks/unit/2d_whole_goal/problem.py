"""
2D grid whole-array goal — fill cells, compare whole array in goal.
PDDL-XTS: 2d_whole_goal
"""
import sys, os
...
def get_problem():
    ...
    # Plan: fill(0,0,1), fill(1,1,2), fill(2,2,1)
    p.add_goal(Equals(board, [[1,0,0,0],[0,2,0,0],[0,0,1,0]]))
    return p
